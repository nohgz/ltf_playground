...
def worker_loop():
    ...
    while True:
        ...
        Wake_local = find_wake_def_shape_local(
            ...
            R=R,
            phi=phi_val,
            energy=energy, # this is global might be able to change
            xGauss=g_xGauss, # might be able to alienate this guy from problem
            AmpGauss=AmpGauss,     # could do a similar thing here
            SigGauss=g_sigGauss      # and here
        )
